...
Learning demo: the same Slack-style chat as **convex-chat**, rebuilt with **Clean Architecture**. Match [docs/PRODUCT.md](docs/PRODUCT.md). Do not copy Convex APIs, `useQuery`, or document `_id` fields.
...
| Package | Role |
| --- | --- |
| `packages/domain` | Enterprise rules. No I/O. |
