...
Start with **PRODUCT.md** for screens and rules. Use **DOMAIN.md** for the TypeBox entity shapes. Use **ARCHITECTURE.md** for package boundaries. The Convex implementation’s file map is **not** the source of truth here.
